...
public static class ReflectionHelpers
{
    ...
    public static Item GetDogtagItem(Player __instance)
    {
        ...
        var dogtagItem = ReflectionHelpers.GetFieldOrPropertyFromInstance<object>(dogtagSlot, "ContainedItem") as Item;
        return dogtagItem;
    }

    public static Type GetGenericWithArgs(Type generic, Type[] typeArgs)
    {
    ...
    {
        var genericType = GetGenericWithArgs(typeof(Singleton<>), new Type[] { singletonInstanceType });
    ...
    {
        return await Task.Run(() => GetFieldOrPropertyFromInstance<T>(o, name));
    }
    ...
    public static FieldInfo FindAndCacheFieldInfo(object o, string fieldName)
    {
        ...
        if (field == null)
        {
            ...
            if (field != null)
            {
                ...
                Plugin.Logger.LogDebug($"Added {type.Name},{fieldName} to {nameof(_cachedFields)}");
            }
        }
    ...
    public static PropertyInfo FindAndCachePropertyInfo(object o, string name)
    {
        ...
        if (property == null)
        {
            ...
            if (property != null)
            {
                ...
                Plugin.Logger.LogInfo($"Added {type.Name},{name} to {nameof(_cachedProperties)}");
            }
        }
